...
Modification in Client7z.cpp
------------

In the file 7zSrc\CPP\7zip\UI\Client7z\Client7z.cpp, we have made certain modifications. 
We added code to provide export functions that can be called externally.
These functions are used to report the decompression progress and the result of the decompression process. 
The copyright of this modification belongs to Copyright (c) 2022 Lark Technologies Pte. Ltd.
